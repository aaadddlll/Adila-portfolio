...
const projects: Project[] = [
  { no: "01", title: "“田园小戏匠”公益项目", type: "乡村振兴 × 少儿戏剧", year: "2025.02 — 2025.06", desc: "在拾星者社会工作机构参与“田园小戏匠”项目，以戏剧体验连接乡村文化与少儿公益教育，推进项目策划、现场执行、内容传播与效果复盘。", result: "活动参与人数较往期提升 25% · 收集有效问卷 300+ 份", context: "项目面向儿童与家庭，将乡村振兴主题转化为可参与的戏剧活动，希望让孩子在角色扮演和共同创作中认识乡村文化，同时提升公益项目的参与度与传播力。", challenge: "需要兼顾少儿活动的趣味性、教育意义与现场可执行性，并通过完整的影像和公众号内容，把一次线下活动沉淀为可持续传播、可复盘优化的项目资产。", process: ["结合往期活动反馈参与方案打磨，梳理戏剧环节、人员分工与现场流程，协同团队保障项目顺利落地", "负责签到、秩序维护与现场影像记录，并独立完成活动纪录片的脚本撰写、拍摄和剪辑", "参与机构公众号运营，完成活动宣传与项目介绍类推文的撰写、排版及发布，把控内容质量与传播节奏", "活动后统计核心数据并收集 300+ 份有效满意度问卷，提炼项目亮点、用户反馈与后续优化方向"], contribution: "贯穿项目前期策划、现场执行、纪录片制作、公众号传播与效果复盘全流程，将活动体验转化为完整的内容资产与改进依据。" },
];
