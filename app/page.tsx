...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    points: [{ text: "通过访谈、活动反馈与线上社群观察识别老年群体数字化学习需求，支持课程体系优化" }, { text: "策划并落地 AI 学习、短视频制作及直播教学等 10 余场活动，覆盖 500 余名用户，满意度达 95%；“老年剧组”项目获得长宁区奖项并获央视报道", detail: "senior-film" }, { text: "对接讲师、场地及内部运营团队，协调排期、资源和执行需求，持续优化项目流程" }, { text: "收集满意度问卷 400+ 份，复盘参与数据、预算与执行效果，输出项目总结报告" }],
