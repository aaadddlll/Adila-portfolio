...
function MarsCase({ view, onClose }: { view: "mars-social" | "mars-event" | "mars-customer" | "mars-kol"; onClose: () => void }) {
  ...
  return <article className="pepsi-case mars-case" aria-live="polite">
    ...
    {view === "mars-customer" && <>
      <section className="case-block"><div className="case-block-title"><span>01</span><div><small>CUSTOMER EDUCATION & SERVICE</small><h4>客户运营与赋能服务</h4><p>围绕 B 端繁育客户的真实经营需求，通过专业课程、公开课、直播教学和内容共创提供持续的客户教育与服务支持，帮助客户提升专业知识、内容经营及获客能力，并在长期互动中维护和深化客户关系。</p></div></div><div className="academy-gallery"><figure><img src="/mars/academy.jpg" alt="皇家繁育学园小程序首页"/><figcaption>平台首页</figcaption></figure><figure><img src="/mars/academy-courses.jpg" alt="皇家繁育学园课程专区"/><figcaption>课程专区 · 新媒体赋能</figcaption></figure><figure><img src="/mars/academy-library.jpg" alt="皇家繁育学园专业书籍专区"/><figcaption>专业书籍 · 繁育知识库</figcaption></figure></div><div className="academy-intro"><strong>小程序是客户服务的重要触点</strong><p>协助负责皇家繁育学园小程序，将客户需求转化为可落地的内容与功能迭代。</p><ul className="academy-ops"><li><span>01</span><div><b>需求收集</b><p>结合问卷、课程反馈与客户沟通，识别繁育客户在学习、经营和内容能力上的真实需求。</p></div></li><li><span>02</span><div><b>路径梳理</b><p>梳理从内容发现、课程学习到持续使用的 User Journey，定位影响体验和留存的关键触点。</p></div></li><li><span>03</span><div><b>上线与优化</b><p>协同推进新课程、专业书籍及平台功能的策划、审核和上线，并根据使用反馈持续优化。</p></div></li></ul></div></section>
